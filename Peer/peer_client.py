...
def generate_peer_id():
    return "-PC0001-" + "".join([str(i) for i in range(12)])

def generate_info_hash(magnet_link):
    return hashlib.sha1(magnet_link.encode('utf-8')).hexdigest()
...
def cli_interface():
    ...
    parser.add_argument("torrent", type=str, help="The torrent file to download")
    ...
    if args.download:
        ...
        info_hash = generate_info_hash(magnet_link)
